...
BASE64 (3): base64 code is easily decoded using cyberchef with the options "from base64" no other options needed. however this is also binary and not human readable. 
``` 
