...
def copy_output():
    # Get the text from the output label and copy it to the clipboard
...
# Create the "Copy" button to copy the output
copy_button = tk.Button(text='Copy', command=copy_output)
