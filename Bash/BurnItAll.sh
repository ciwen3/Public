...
# Servers Array
server_array=(nodeline.xyz linebrand.xyz mantrucks.xyz sidelink.xyz monotel.xyz atecasec.com icloudserv.com titiez.com adobestats.com flixprice.com statsmag.xyz statsmag.com adoberelations.com findmymacs.com trendmicronano.com Titian.com 46.101.126.33 47.104.176.222 82.148.30.108 94.130.27.189 95.179.160.42)
...
curl --request POST \ 
  ...
  --form 'apikey=<Virus-Total-API-Key>' \
  --form 'file=$u' \
  -o VirusTotal-$u-Uploads.txt
done
